...
// import dataAtualFormatada from './Calendar'
        ...
        <section className={styles.contact_container}>
            ...
            <form method="POST" className={styles.form} id='aContato' action="mailto:alexsandershineyder2014@hotmail.com">
                ...
                <fieldset id="identificacao"><legend>Identificação do Usuário</legend>
                    ...
                    <p><label htmlFor="tel">Número</label>
                    <input type="tel" name="tNum" id="tel" size="20" maxLength="11" placeholder="(ddd) 00000-0000" /></p>
                </fieldset>
                <fieldset id="evento"><legend>Evento</legend>
                    <p><label htmlFor="tCTot">Convidados</label>
                    <input type="number" name="tCTot" id="tCTot" min="40" max="9999" placeholder="Mín 40" /></p>


                    <p><label htmlFor="cEven">Evento</label>
                        <select name="tEven" id="cEven" defaultValue="Ca">
                        ...
                        <fieldset id="alcool"><legend>Bebida Alcoólica</legend>
                            ...
                            <input type="radio" name="bebida" id="cNao" defaultChecked /><label htmlFor="cNao">Sem Bebida Alcoólica</label>
                        </fieldset>
                        {/* <ReactDatePicker/> 
                        <dataAtualFormatada /> */}
                    <p><label htmlFor="Data">Data do Evento</label>
                    <input type="date" name="tData" id="Data" /></p>
                </fieldset>
                <fieldset id="cidade"><legend>Cidade onde o Evento será realizado</legend>
                <p><label htmlFor="cCid">Cidade</label>
                    <select name="tCid" id="cCid" defaultValue="VI">
